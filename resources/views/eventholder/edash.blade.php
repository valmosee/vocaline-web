...
<body class="overflow-x-hidden">
  ...
  <header class="bg-[#0A0A23] text-white py-4 px-6 flex justify-between items-center">
    ...
    <a href="{{ route('register') }}"
      class="px-6 py-2 bg-yellow-400 text-black font-semibold rounded-full hover:bg-yellow-300 hover:scale-105 transition-all duration-300 shadow-lg"
  ...
  <section id="services" class="bg-shared py-24 px-6 md:px-12">
    ...
    <div class="max-w-3xl mx-auto">
        ...
        <div class="space-y-6 p-8 rounded-lg shadow-xl" data-aos="fade-up">
        <a href="{{ route('login') }}" 
            class="block text-center bg-yellow-400 text-black font-semibold py-3 px-6 rounded-full hover:bg-yellow-300 hover:scale-105 transition-all duration-300 shadow-lg">
            Add Your Event
        </a>
        </div>
    </div>
